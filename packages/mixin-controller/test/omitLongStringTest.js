...
describe('omit-too-long-string', () => {
  ...
  it('Do test', () => {
    equal(omitLongString(null), null)
    equal(omitLongString('too long text', { maxLength: 3 }), 'too...')
    deepStrictEqual(omitLongString(['foo', 'barrrr', 2000], { maxLength: 3 }), [
      'foo',
      'bar...',
      2000,
    ])
    ...
    deepStrictEqual(
      omitLongString(
        { a: [1, { b: 'abc', c: 'abc', d: 'abcd' }], e: null, f: true },
        { maxLength: 3 },
      ),
